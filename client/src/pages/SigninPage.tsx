...
function SigninPage() {
  ...
  return (
    <section className="py-20 2xl:py-40 bg-gray-800 min-h-screen">
      <img
            ...
            <div className="w-full lg:w-1/2 px-4 mb-16 lg:mb-0">
              <div className="max-w-md">
                ...
                <h2 className="mt-8 mb-12 text-5xl font-bold font-heading text-white">
                  Number one Escrow Service you'll find in Nigeria.
                </h2>
                <p className="text-lg text-gray-200">
                  <span>We pride in the quality of service </span>
            ...
            <div className="w-full lg:w-1/2 px-4">
              <div className="px-6 lg:px-20 py-12 lg:py-24 bg-gray-600 rounded-lg">
                <form onSubmit={login}>
                  ...
                  <label className="inline-flex my-4">
